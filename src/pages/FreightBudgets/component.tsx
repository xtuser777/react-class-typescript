...
import { IFreightBudgetsState } from './types';
import { FreightBudgetsFunctions } from './functions';
import { FreightBudgetsHandles } from './handles';

export class FreightBudgetsComponent extends Component<unknown, IFreightBudgetsState> {
  private functions: FreightBudgetsFunctions;
  private handles: FreightBudgetsHandles;

  constructor(props: unknown) {
    super(props);

    this.functions = new FreightBudgetsFunctions(this);
    this.handles = new FreightBudgetsHandles(this, this.functions);
